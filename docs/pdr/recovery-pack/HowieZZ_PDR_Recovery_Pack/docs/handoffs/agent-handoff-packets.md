...
- pdr_path: docs/pdr/recovery-pack/HowieZZ_PDR_Recovery_Pack/docs/pdr/PDR-002-homepage-concierge-landing.md
...
- task_id: HZZ-P1-003
- pdr_path: docs/pdr/recovery-pack/HowieZZ_PDR_Recovery_Pack/docs/pdr/PDR-008-analytics-event-taxonomy.md
...
- task_id: HZZ-P2-004
- pdr_path: docs/pdr/recovery-pack/HowieZZ_PDR_Recovery_Pack/docs/pdr/PDR-010-competitor-family-coverage-roi-validation.md
...
- task_id: HZZ-P3-001
- pdr_path: docs/pdr/recovery-pack/HowieZZ_PDR_Recovery_Pack/docs/pdr/PDR-007-seo-og-structured-data-build-layer.md
